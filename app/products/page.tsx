      ...
      <section className="px-6 pb-16 pt-20 lg:px-8 lg:pb-24 lg:pt-28">
        <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 grid gap-3 sm:grid-cols-2">
                    {product.features.map((feature) => (
                      ...
                      >
                        <span className="mt-0.5 font-bold text-pixel-green">
                          ✓
                        </span>
                        <span>{feature}</span>
                      </li>
          ...
          <article className="mt-8 rounded-3xl border border-teal-100 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-lg lg:p-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-pixel-light-teal text-2xl font-extrabold text-pixel-teal">
              D
            </div>
